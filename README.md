...
We recommend to install the client via the prebuilt Docker image `hub.terrestris.de/shogun/shogun-gis-client`.
...
| print.outputFormats | The list of output formats available in the combobox. Note: Only formats supported by your Mapfish print servlet should be entered here.                                                                                                                                                                     | '[\'pdf\', \'png\']'            |
...
services:
  shogun-gis-client:
    image: hub.terrestris.de/shogun/shogun-gis-client:latest
    volumes:
